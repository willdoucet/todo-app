...
**Completed (9-phase implementation — see `.agents/plans/features/dashboard/icloud-setup-plan-summary.md`):**
...
**Status:** in-progress (5 of 8 milestones shipped, 1 subsumed) · **Epic:** [v1-productionization](../plans/epics/v1-productionization/v1-productionization-epic-20260421-182714.md) · **Rationale and reviews:** [prod-contract-freeze plan](../plans/features/prod-contract-freeze/prod-contract-freeze-plan-20260421-182714.md)

**Goal:** Take the repo from local-only `docker-compose` dev state to a secure v1 production deployment.

> The epic owns milestone definitions and locked decisions; the registry owns milestone status.
> `/ship` updates this table. Run `.agents/bin/obsidian-workflow epic-get --slug v1-productionization` for the live view.
...
|---|---|---|---|---|---|---|
| M1 | Contract freeze: doc alignment, branch protection, squash-merge | plan | shipped | `prod-contract-freeze` | [plan](../plans/features/prod-contract-freeze/prod-contract-freeze-plan-20260421-182714.md) | 2026-04-22 (#25) |
| M2 | Deploy skeleton: Fly + Upstash + R2 + Vercel + DNS, `/healthz`, Cloudflare Access edge gate, split-origin cookie plumbing test | plan | shipped | `prod-deploy-skeleton` | [plan](../plans/features/prod-deploy-skeleton/prod-deploy-skeleton-plan-20260422-214657.md) | 2026-05-01 (#26) |
| M3 | Auth backend foundation: auth models + migrations, argon2, `/auth/register` (gated by `HOUSEHOLD_ACCESS_KEY`), `/auth/login`, `/auth/refresh` (60s rotation grace), `/auth/logout`, `/auth/status`, hashed refresh tokens, session-version revocation | plan | shipped | `prod-auth-backend-foundation` | [plan](../plans/features/prod-auth-backend-foundation/prod-auth-backend-foundation-plan-20260501-170804.md) · [plain-English summary](../../todo-app-notes/DevOps/Learning/M3%20Auth%20Backend%20-%20Plain%20English%20Summary.md) | 2026-05-03 (#28; follow-ups #29, #30, #31) |
| M4 | Auth frontend session: centralized `frontend/src/lib/api.js`, unified `/auth` portal, in-memory access token, boot-sequence refresh, `return_to`, silent refresh on 401 | plan | shipped | `prod-auth-frontend-session` | [plan](../plans/features/prod-auth-frontend-session/prod-auth-frontend-session-plan-20260503-185400.md) · [plain-English summary](../../todo-app-notes/DevOps/Learning/M4%20Auth%20Frontend%20-%20Plain%20English%20Summary.md) | 2026-05-04 (#33) |
...
| M7 | R2 storage: storage abstraction, backend-proxied uploads with atomic R2+DB transaction, UUID-keyed objects, private reads with first-party auth, authenticated route for stock icons, remove the `/uploads` StaticFiles mount. PR1 (foundation: storage seam, assets manifest, upload hardening, lifecycle hooks, sweep) merged; PR2 (R2 enablement, cookie read-proxy, ETag, mount removal, CF Access Application 1 teardown) pending. | plan | implementing | `prod-r2-storage` | [plan](../plans/features/prod-r2-storage/prod-r2-storage-plan-20260715-201232.md) | PR1 2026-09-09 (#41) |
| M8 | Launch release: manual release runbook committed; smoke + rollback checklists; operator password-rotation CLI (via `fly ssh console`); backup-restore dry-run against a scratch Fly Postgres; `fly scale show` verifies `web=1, worker=1, beat=1` before closing any release | plan | not-started | `prod-launch-release` | — | — |
...
**Plan:** `.agents/plans/features/lists-ui-update-inline-edits/lists-ui-update-inline-edits-plan-20260401-161442.md`
**Mockup:** `../plans/features/lists-ui-update-inline-edits/mockups/inline-edit-mockup-b.html`
...
**Plan:** [`.agents/plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260402-164137.md`](../plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260402-164137.md)
...
**Branch:** `mealboard-main-page-updates`
**Plan:** [`.agents/plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260405-180444.md`](../plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260405-180444.md)
...
**Branch:** `mealboard-main-page-updates`
**Plan:** [`.agents/plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260413-135505.md`](../plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260413-135505.md)
...
**Plan:** [`.agents/plans/features/mealboard-ai-recipe-creator/mealboard-ai-recipe-creator-plan-20260416-151059.md`](../plans/features/mealboard-ai-recipe-creator/mealboard-ai-recipe-creator-plan-20260416-151059.md)
...
**Plan:** [`.agents/plans/features/mealboard-meal-card-polish/mealboard-meal-card-polish-plan-20260417-213900.md`](../plans/features/mealboard-meal-card-polish/mealboard-meal-card-polish-plan-20260417-213900.md)
...
> **This feature is now part of Phase 3.6 (Mealboard Overhaul).** The overhaul implements automatic shopping list sync with ingredient aggregation, unit conversion, and Celery-based async processing. See the [mealboard overhaul plan](../plans/features/mealboard-main-page-updates/mealboard-main-page-updates-plan-20260402-164137.md) for full spec.
