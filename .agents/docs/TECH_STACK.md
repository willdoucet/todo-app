...
| File Storage | Cloudflare R2 | User uploads (photos, icons) — provisioned in M2; cutover executed 2026-09-11 (`infra/r2-cutover-runbook.md`); see Object storage below |
